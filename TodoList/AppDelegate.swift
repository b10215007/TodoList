...
class AppDelegate: UIResponder, UIApplicationDelegate {
  ...
  func application(_ application: UIApplication, didRecive notification: UILocalNotification){
    print("Print entire notification massage for Preview: \(notification)")
  ...
  func applicationDidEnterBackground(_ application: UIApplication) {
    backgroundTask = UIApplication.shared.beginBackgroundTask(expirationHandler: {
      NSLog("Application work in background")
    })
  }
